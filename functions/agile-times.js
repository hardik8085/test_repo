...
function addTimesheet(intent, session, callback) {
    ...
    if (projectSlot && typeof(projectSlot.value) !== 'undefined') {
        ...
        speechOutput = categorySlot && typeof(categorySlot.value) !== 'undefined' ? `Got it. Adding new timesheet to ${project} project, ${category} category for hardik thakkar.` : `Got it. Adding new timesheet to ${project} project for hardik thakkar.`;
    } else {
